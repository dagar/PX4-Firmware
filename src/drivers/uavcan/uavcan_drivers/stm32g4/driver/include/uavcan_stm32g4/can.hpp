...
#include <uavcan_stm32g4/fdcan.hpp>
...
public:
	...
	CanIface(fdcan::CanType *can, BusEvent &update_event, uavcan::uint8_t self_index,
		...
		, had_activity_(false)
	{
		UAVCAN_ASSERT(self_index_ < UAVCAN_STM32G4_NUM_IFACES);
	}
...
public:
	...
	CanDriver(CanRxItem(&rx_queue_storage)[UAVCAN_STM32G4_NUM_IFACES][RxQueueCapacity])
		: update_event_(*this)
	...
	virtual uavcan::uint8_t getNumIfaces() const { return UAVCAN_STM32G4_NUM_IFACES; }
...
class CanInitHelper
{
	CanRxItem queue_storage_[UAVCAN_STM32G4_NUM_IFACES][RxQueueCapacity];
