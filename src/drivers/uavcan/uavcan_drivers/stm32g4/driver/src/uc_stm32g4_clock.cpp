...
#include <uavcan_stm32g4/thread.hpp>
#include "internal.hpp"

#if UAVCAN_STM32G4_TIMER_NUMBER
...
#  define TIMX                    UAVCAN_STM32G4_GLUE3(STM32_TIM, UAVCAN_STM32G4_TIMER_NUMBER, _BASE)
#  define  TMR_REG(o)              (TIMX + (o))
#  define TIMX_INPUT_CLOCK         UAVCAN_STM32G4_GLUE3(STM32_APB1_TIM, UAVCAN_STM32G4_TIMER_NUMBER, _CLKIN)

#  define TIMX_IRQn                UAVCAN_STM32G4_GLUE2(STM32_IRQ_TIM, UAVCAN_STM32G4_TIMER_NUMBER)
# endif

# if UAVCAN_STM32G4_TIMER_NUMBER >= 2 && UAVCAN_STM32G4_TIMER_NUMBER <= 7
#  define TIMX_RCC_ENR           RCC->APB1ENR
#  define TIMX_RCC_RSTR          RCC->APB1RSTR
#  define TIMX_RCC_ENR_MASK      UAVCAN_STM32G4_GLUE3(RCC_APB1ENR_TIM,  UAVCAN_STM32G4_TIMER_NUMBER, EN)
#  define TIMX_RCC_RSTR_MASK     UAVCAN_STM32G4_GLUE3(RCC_APB1RSTR_TIM, UAVCAN_STM32G4_TIMER_NUMBER, RST)
# else
#  error "This UAVCAN_STM32G4_TIMER_NUMBER is not supported yet"
# endif

/**
 * UAVCAN_STM32G4_TIMX_INPUT_CLOCK can be used to manually override the auto-detected timer clock speed.
 ...
 *
 *      -DUAVCAN_STM32G4_TIMX_INPUT_CLOCK=STM32_HCLK
 *
 * Alternatively, the new clock rate can be specified directly.
 */
# ifdef UAVCAN_STM32G4_TIMX_INPUT_CLOCK
#  undef TIMX_INPUT_CLOCK
#  define TIMX_INPUT_CLOCK      UAVCAN_STM32G4_TIMX_INPUT_CLOCK
# endif

extern "C" UAVCAN_STM32G4_IRQ_HANDLER(TIMX_IRQHandler);
...
extern "C"
UAVCAN_STM32G4_IRQ_HANDLER(TIMX_IRQHandler)
{
...
# endif
	...
	using namespace uavcan_stm32g4::clock;
	UAVCAN_ASSERT(initialized);
