 ...
 * @details		This file provides fault handlers.
 * 
...
/*!***************************************************************************
 * @defgroup	handlers Exception Handlers
 * @ingroup		driver
 * @brief 		Handlers for System Exceptions.
 * @details		Dummy Handlers for System Exceptions.
 * @addtogroup 	handlers
 * @{
 *****************************************************************************/
 ...
 * @details	A Non-Maskable Interrupt (NMI) can be signaled by a peripheral or
 * 			triggered by software. This is the highest priority exception
 ...
 * @details	A HardFault is an exception that occurs because of an error.
 * 			HardFaults have a fixed priority of -1, meaning they have higher
 ...
 * @details	A Supervisor Call (SVC) is an exception that is triggered by the
...
/*!***************************************************************************
 * @brief	Generic hardfault handler
 * @details	Called by HardFault_Handler, after collecting data.
 *****************************************************************************/
...
// Reference: https://www.segger.com/downloads/application-notes/AN00016
