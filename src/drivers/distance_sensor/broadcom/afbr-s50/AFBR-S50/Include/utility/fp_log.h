...
static inline q15_16_t fp_log16(uq16_16_t x)
{
	...
	if ((t & 0x80000000) == 0) { x = t, y -= 0x0067CC90; }

	t = x + (x >> 2);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x00391FF0; }

	t = x + (x >> 3);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x001E2707; }

	t = x + (x >> 4);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x000F8518; }

	t = x + (x >> 5);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x0007E0A7; }

	t = x + (x >> 6);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x0003F815; }

	t = x + (x >> 7);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x0001FE03; }

	t = x + (x >> 8);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x0000FF80; }

	t = x + (x >> 9);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x00007FE0; }

	t = x + (x >> 10);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x00003FF8; }

	t = x + (x >> 11);

	if ((t & 0x80000000) == 0) { x = t, y -= 0x00001FFE; }
