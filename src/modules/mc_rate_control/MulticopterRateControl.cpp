...
MulticopterRateControl::control_attitude_rates(float dt)
{
	...
	if ((_v_control_mode.flag_control_velocity_enabled || _v_control_mode.flag_control_auto_enabled) &&
	    _v_rates_sp.disable_mc_yaw_control == true && !_v_control_mode.flag_control_manual_enabled) {
	...
	while (!_task_should_exit) {
		...
		if (_gyro_corrected_sub.update()) {
			...
			if (_v_control_mode.flag_control_rates_enabled) {
				...
				_actuators.control[7] = _v_rates_sp.landing_gear; // TODO: dagar fix landing gear and weathervane
				_actuators.timestamp = hrt_absolute_time();
				_actuators.timestamp_sample = _gyro_corrected_sub.get().timestamp;
